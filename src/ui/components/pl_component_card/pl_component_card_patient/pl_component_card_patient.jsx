...
export class PlComponentCardPatient extends Component {
    ...
    render_menu(patient, father, mother, children, mode_menu, mode_edit) {
        ...
        var icon_data =
            <svg width='40' height='40' viewBox='0 0 24 24' fillRule='evenodd'>
        ...
        var icon_comments = 
            <svg width="40" height="40" viewBox="0 0 60 60" style={{"enableBackground":"new 0 0 485.211 485.211"}} xmlSpace="preserve">
