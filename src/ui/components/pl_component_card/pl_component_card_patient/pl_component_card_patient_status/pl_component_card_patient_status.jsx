...
export class PlComponentCardPatientStatus extends Component {
    ...
    render() {
        ...
        //         "gender": "male",
        //         "svg": <svg width="45" height="45"><rect id="svg_5" height="30" width="30" y="7.5" x="7.5" strokeOpacity="null" strokeWidth="1.5" stroke="#000" fill="#000000" /><line strokeWidth="2" strokeLinecap="null" strokeLinejoin="null" id="svg_17" y2="4.624963" x2="41" y1="41.624963" x1="3" fillOpacity="null" strokeOpacity="null" stroke="#000" fill="none" /></svg>
        //     },
        //     {
        //         "status": "muerte-subita",
        //         "gender": "female",
        ...
        var genotype_types = [
            ...
            },
            {
                ...
                "svg": <line strokeLinecap="null" strokeLinejoin="null" id="svg_24" y2="23.249907" x2="26.937654" y1="23.249907" x1="16.312663" fillOpacity="null" strokeOpacity="null" strokeWidth="2" stroke="#000" fill="none" />
            },
            {
            ...
            },
            {
                ...
                "svg": <text textAnchor="start" fontFamily="Helvetica, Arial, sans-serif" fontSize="24" id="svg_61" y="28.928437" x="14.9377" fillOpacity="null" strokeOpacity="null" strokeWidth="0" stroke="#000" fill="grey">+</text>
 
            }
        ]

        var patient_genotype = where(genotype_types, { genotype: genotype });
        
        var patient_genotype_svg;
        if (patient_genotype.length === 1) {
            
            patient_genotype_svg = patient_genotype[0].svg;
