(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('prop-types'), require('react'), require('classnames'), require('carbon-icons'), require('react-dom')) :
	typeof define === 'function' && define.amd ? define(['exports', 'prop-types', 'react', 'classnames', 'carbon-icons', 'react-dom'], factory) :
	(factory((global.CarbonComponentsReact = {}),global.PropTypes,global.React,global.classNames,global.CarbonIcons,global.ReactDOM));
}(this, (function (exports,PropTypes,React,classNames,icons,ReactDOM) { 'use strict';
...
var Downshift$1 = function (_Component) {
  ...
  createClass(Downshift, [{
    ...
    value: function focusInput() {
      var inputNode = this._rootNode.querySelector('[id="' + this.inputId + '"]');
    ...
    value: function internalSetState(stateToSet, cb) {
      ...
      if (!isStateToSetFunction && stateToSet.hasOwnProperty('inputValue')) {
        this.props.onInputValueChange(stateToSet.inputValue, _extends$1({}, this.getStateAndHelpers(), stateToSet));
      }
      return this.setState(function (state) {
        ...
        if (isStateToSetFunction && stateToSet.hasOwnProperty('inputValue')) {
          _this3.props.onInputValueChange(stateToSet.inputValue, _extends$1({}, _this3.getStateAndHelpers(), stateToSet));
        }
...
var _initialiseProps = function () {
  ...
  this.setHighlightedIndex = function () {
    ...
    _this5.internalSetState(_extends$1({ highlightedIndex: highlightedIndex }, otherStateToSet));
  };
  ...
  this.openAndHighlightDefaultIndex = function () {
    ...
    _this5.setHighlightedIndex(undefined, _extends$1({ isOpen: true }, otherStateToSet));
  };
  ...
  this.selectItem = function (item, otherStateToSet, cb) {
    otherStateToSet = pickState(otherStateToSet);
    _this5.internalSetState(_extends$1({
      isOpen: false,
    ...
    }, otherStateToSet), function () {
      _this5.focusInput();
      typeof cb === 'function' && cb.apply(undefined, arguments);
    });
  };
  ...
  this.getRootProps = function () {
    ...
    return _extends$1(defineProperty({}, refKey, _this5.rootRef), rest);
  };
  ...
  this.updateStatus = debounce(function () {
    ...
    var status = _this5.props.getA11yStatusMessage(_extends$1({
...
var ListBox = function ListBox(_ref) {
  ...
  var className = classNames((_cx = {}, _defineProperty(_cx, containerClassName, !!containerClassName), _defineProperty(_cx, 'bx--list-box', true), _defineProperty(_cx, 'bx--form-item', true), _defineProperty(_cx, 'bx--list-box--inline', type === 'inline'), _defineProperty(_cx, 'bx--list-box--disabled', disabled), _cx));
  return React__default.createElement("div", _extends({
    className: className,
    ref: innerRef
  }, rest), children);
...
function (_React$Component) {
  ...
  _createClass(ComboBox, [{
    ...
    value: function render() {
      ...
      return React__default.createElement(Downshift$1, {
...
var _initialiseProps$1 = function _initialiseProps() {
  ...
  Object.defineProperty(this, "getSelectionProps", {
    ...
    value: function value() {
      ...
      var checked = _this3.state.rowIds.length > 0 ? _this3.getSelectedRows().length === _this3.state.rowIds.length : false;
...
var InlineCheckbox = function InlineCheckbox(_ref) {
  var id = _ref.id,
...
function (_Component) {
  ...
  function Search() {
    ...
    }), Object.defineProperty(_assertThisInitialized(_this), "searchFilterBtn", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value() {
    ...
    }), Object.defineProperty(_assertThisInitialized(_this), "searchLayoutBtn", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value() {
        if (!_this.props.small) {
          ...
          }, _this.state.format === 'list' ? React__default.createElement("div", {
  ...
  _createClass(Search, [{
    ...
    value: function render() {
      ...
      }), this.searchFilterBtn(), this.searchLayoutBtn());
    }
  }]);
  ...
  _createClass(DatePicker, [{
    ...
    value: function render() {
      ...
      var _props2 = this.props,
          ...
          other = _objectWithoutProperties(_props2, ["children", "className", "short", "datePickerType", "dateFormat", "onChange"]);
  ...
  _createClass(Tabs, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          other = _objectWithoutProperties(_props, ["iconDescription", "className", "triggerHref", "role", "onSelectionChange"]);
        ...
        if (menuBody) {
          ...
          _this._hFocusIn = on(menuBody.ownerDocument, focusinEventName, function (event) {
            if (!menuBody.contains(event.target)) {
              ...
              _this.menuEl && _this.menuEl.focus();
            }
          }, !hasFocusin);
        } else if (_this._hFocusIn) {
...
function (_Component) {
  ...
  function DetailPageHeader() {
    ...
    return _possibleConstructorReturn(_this, (_temp = _this = _possibleConstructorReturn(this, (_ref = DetailPageHeader.__proto__ || Object.getPrototypeOf(DetailPageHeader)).call.apply(_ref, [this].concat(args))), Object.defineProperty(_assertThisInitialized(_this), "state", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: {
...
function (_Component) {
  ...
  function InteriorLeftNavList() {
    ...
    return _possibleConstructorReturn(_this, (_temp = _this = _possibleConstructorReturn(this, (_ref = InteriorLeftNavList.__proto__ || Object.getPrototypeOf(InteriorLeftNavList)).call.apply(_ref, [this].concat(args))), Object.defineProperty(_assertThisInitialized(_this), "state", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: {
...
function (_Component) {
  ...
  function InteriorLeftNav() {
    ...
    return _possibleConstructorReturn(_this, (_temp = _this = _possibleConstructorReturn(this, (_ref = InteriorLeftNav.__proto__ || Object.getPrototypeOf(InteriorLeftNav)).call.apply(_ref, [this].concat(args))), Object.defineProperty(_assertThisInitialized(_this), "state", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: {
  ...
  function MultiSelect(props) {
    ...
    Object.defineProperty(_assertThisInitialized(_this), "handleOnStateChange", {
      ...
      value: function value(changes) {
        ...
        switch (type) {
          case Downshift$1.stateChangeTypes.keyDownArrowDown:
          case Downshift$1.stateChangeTypes.keyDownArrowUp:
          case Downshift$1.stateChangeTypes.itemMouseEnter:
            _this.setState({
          ...
          case Downshift$1.stateChangeTypes.clickButton:
          case Downshift$1.stateChangeTypes.keyDownSpaceButton:
...
var OverflowMenuItem = function OverflowMenuItem(_ref) {
  var className = _ref.className,
      ...
      wrapperClassName = _ref.wrapperClassName,
      other = _objectWithoutProperties(_ref, ["className", "itemText", "hasDivider", "isDelete", "closeMenu", "onClick", "primaryFocus", "wrapperClassName"]);
  ...
  _createClass(Pagination, [{
    ...
    value: function render() {
      ...
      return React__default.createElement("div", _extends({
        ...
        className: "bx--pagination__text"
      }, pagesUnknown ? itemText(statePageSize * (statePage - 1) + 1, statePage * statePageSize) : itemRangeText(statePageSize * (statePage - 1) + 1, Math.min(statePage * statePageSize, totalItems), totalItems))), React__default.createElement("div", {
        className: "bx--pagination__right"
      }, React__default.createElement("span", {
        className: "bx--pagination__text"
      }, pagesUnknown ? pageText(statePage) : pageRangeText(statePage, Math.ceil(totalItems / statePageSize))), React__default.createElement("button", {
  ...
  _createClass(PaginationV2, [{
    ...
    value: function render() {
      ...
      return React__default.createElement("div", _extends({
        ...
        className: "bx--pagination__text"
      }, itemsPerPageText, ":\xA0\xA0"), React__default.createElement(Select, {
        id: "bx-pagination-select-".concat(inputId),
        labelText: itemsPerPageText,
        hideLabel: true,
        inline: true,
        ...
        className: "bx--pagination__text"
      }, "\xA0|\xA0\xA0", pagesUnknown ? itemText(statePageSize * (statePage - 1) + 1, statePage * statePageSize) : itemRangeText(statePageSize * (statePage - 1) + 1, Math.min(statePage * statePageSize, totalItems), totalItems))), React__default.createElement("div", {
  ...
  _createClass(ExpandableTile, [{
    ...
    value: function render() {
      ...
      var _props4 = this.props,
          ...
          other = _objectWithoutProperties(_props4, ["tabIndex", "className", "tileMaxHeight", "tilePadding", "handleClick", "expanded"]);
